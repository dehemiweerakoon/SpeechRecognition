...
const Home:React.FC=()=> {
  ...
  const [languages] = useState<string[]>(["English","French","Spanish","Sinhala","Tamil"])
  ...
  return (
    <>
       <div className="w-full bg-white-200 bg-dot-white/[0.2] bg-dot-black/[0.2] relative flex items-center justify-center">
